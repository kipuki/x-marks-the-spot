...
Much thanks to the talented creators who's assets are featured in this project. This project couldn't have existed without them. Below is a list of all assets used:

### Environment & Props

* **Stairs, Lanterns, Rocks**
...
* **Water & Lava Shaders**
  ...
  [Simple Water Shader URP](https://assetstore.unity.com/packages/p/simple-water-shader-urp-191449)

  *Creator:* IgniteCoders

* **Rocks, Flowers & Grass, Trees**
...
* **Cannon**
  ...
  [Stylized Cannon (Hand Painting)](https://assetstore.unity.com/packages/3d/props/weapons/stylized-cannon-hand-painting-216360)

  *Creator:* Infinity3DGame

* **Terrain Textures**

  [Lowpoly Textures Pack](https://assetstore.unity.com/packages/2d/textures-materials/lowpoly-textures-pack-140717)

  *Creator:* N-hance Studio

* **Gem Texture**

  [Simple Collectibles Pack](https://assetstore.unity.com/packages/p/simple-collectibles-pack-123092)

  *Creator:* Dillon Wallace

* **Boat**

  [Boats - PolyPack](https://assetstore.unity.com/packages/p/boats-polypack-189866)

  *Creator:* Alstra Infinite
...
* **Rock Materials**
  ...
  *Creator:* SnowFiend Studios

* **Boat Dock, Treasure Chest, Broken Barrel**

  [Low Poly Tropical Island Lite](https://assetstore.unity.com/packages/3d/environments/low-poly-tropical-island-lite-242437)

  *Creator:* JustCreate

* **Tunnel Entrance Arch, Rocks**

  [Low Poly Environment Starter Pack](https://assetstore.unity.com/packages/3d/environments/low-poly-environment-starter-pack-228606)
...
* **Tunnel Spiders**
  ...
  *Creator:* Dante's Anvil

* **Tunnel Obstacle Models**

  [Traps and Obstacles Pack](https://assetstore.unity.com/packages/3d/environments/traps-and-obstacles-pack-195360)
